  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    {#if publicFeedState.isLoading && publicFeedState.items.length === 0}
      <div class="flex justify-center items-center py-20">
        <div class="text-center">
          <div class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gray-50 dark:bg-gray-800/50 mb-4 border border-gray-200/50 dark:border-gray-700/50">
            <div class="w-5 h-5 border-2 border-gray-200 dark:border-gray-700 border-t-indigo-500 dark:border-t-indigo-400 rounded-full animate-spin"></div>
          </div>
          <p class="text-gray-500 dark:text-gray-400 text-sm font-normal">Loading images...</p>
        </div>
      </div>
    {/if}
    ...
    {#if publicFeedState.isEmpty}
      <div class="flex flex-col items-center justify-center py-20 text-center">
        <div class="w-24 h-24 rounded-full bg-gradient-to-r from-indigo-100 to-purple-100 dark:from-indigo-900/30 dark:to-purple-900/30 flex items-center justify-center mb-8">
          <Icon icon="heroicons:photo" class="w-12 h-12 text-indigo-600 dark:text-indigo-400" />
        </div>
        ...
        <Button size="lg" variant="primary" href="/upload" class="px-8 py-3 text-base font-medium">
      ...
      <Masonry items={publicFeedState.items} class="gap-6">
        {#snippet itemTemplate(image)}
          ...
          >
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                  ...
                  <div class="flex-1 min-w-0">
                    <TextEllipsis class="font-medium text-gray-900 dark:text-white text-sm">
            ...
            <div class="px-5 pb-5 flex items-center justify-between text-xs text-gray-500 dark:text-gray-400" class:pt-3={!image.attributes.description?.trim()}>
