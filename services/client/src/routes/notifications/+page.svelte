...
<section in:fade={{ duration: 300 }}>
  <div
    class="flex flex-col px-4 py-8 sm:px-6 lg:px-8 w-full max-w-xl"
    use:skeleton={{
  ...
  >
    ...
    {:else if notificationFeed.isEmpty}
      <div in:fade={{ duration: 200 }} class="py-12">
        <EmptyState
    ...
    {:else}
      <div class="flex flex-col gap-2" in:fade={{ duration: 400, delay: 200 }}>
