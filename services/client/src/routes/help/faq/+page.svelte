...
{#snippet faqItem(slug: string, title: string, content: Snippet)}
  <div
    id={slug}
    class="bg-card rounded-2xl border border-border/50 shadow-sm overflow-hidden transition-all duration-200 hover:shadow-md"
  >
    <button
      class="w-full px-6 py-5 text-left focus:outline-none transition-all duration-200 hover:bg-muted"
    ...
    {#if openedQuestion === slug}
      ...
      >
        <div class="pt-2 border-t border-border">
          <div
            class="prose prose-slate dark:prose-invert max-w-none text-foreground-soft"
          >
            {@render content()}
          </div>
        </div>
...
<div class="min-h-full">
  ...
  >
              ...
              <div class="flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-center gap-2 mb-1">
                    ...
                    >
                    <span
                      class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-surface-raised text-foreground-soft"
                    >
                      Default
                    </span>
                  </div>
            ...
            <ul class="space-y-2">
              <li class="flex items-start gap-2">
                <Icon
                  ...
                  class="w-4 h-4 text-foreground-subtle flex-shrink-0 mt-0.5"
                />
    ...
    <div class="mt-16 text-center">
      <div class="bg-card rounded-2xl border border-border/50 p-8">
        <Icon
          icon="ph:chat-circle-text"
          class="h-12 w-12 text-foreground-subtle mx-auto mb-4"
        />
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center justify-center px-6 py-3 bg-foreground hover:bg-foreground/90 text-background font-medium rounded-xl transition-colors duration-200"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center justify-center px-6 py-3 bg-card hover:bg-muted text-foreground font-medium rounded-xl border border-border transition-colors duration-200"
          >
