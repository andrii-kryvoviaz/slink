...
export const filterIconContainerVariants = cva(
...
export const filterIconVariants = cva('h-3.5 w-3.5 transition-colors', {
  variants: {
    variant: {
...
export type FilterShellVariants = VariantProps<typeof filterShellVariants>;
export type FilterIconContainerVariants = VariantProps<
  typeof filterIconContainerVariants
>;
