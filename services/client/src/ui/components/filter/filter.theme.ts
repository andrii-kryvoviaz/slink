    ...
    variants: {
      variant: {
        default: [
          ...
          'hover:bg-hover',
          'field-focus:border-border-strong dark:field-focus:border-border',
          'field-focus:bg-card',
        ],
        neon: [
          'filter-glass',
          ...
          'field-focus:border-info/40',
          'field-focus:shadow-info-border/30 dark:field-focus:shadow-info-border/9 field-focus:shadow-md',
          'field-focus:bg-primary-solid/10',
          'field-focus:ring-info/15 field-focus:ring-1',
        ],
        minimal: [
          'filter-glass',
          'border border-border/60',
          'hover:bg-hover',
          'field-focus:border-border-strong/80 dark:field-focus:border-border',
        ],
        subtle: [
