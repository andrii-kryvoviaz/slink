...
export const attributeChip = tv({
  slots: {
    ...
    body: 'relative inline-flex min-w-0 cursor-pointer items-center gap-1.5 rounded-full py-1.5 outline-none transition-colors before:absolute before:inset-x-0 before:-inset-y-2 before:content-[""] focus-visible:ring-2 focus-visible:ring-indigo-500/40',
