...
<div class="w-72 max-w-[calc(100vw-2rem)] space-y-4 p-1">
  ...
  <div class="flex gap-2 pt-2">
    <button
      type="button"
      class="flex-1 px-3 py-2 text-sm font-medium text-foreground-soft bg-card border border-border rounded-lg hover:bg-ghost-hover transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring/20 active:scale-[0.98]"
