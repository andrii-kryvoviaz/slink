...
export const viewModeSliderTheme = tv({
  slots: {
    ...
    dot: 'block rounded-full bg-ring/60 dark:bg-ring/70 motion-safe:transition-[transform,background-color] motion-safe:duration-200 group-hover:scale-125 group-hover:bg-muted-foreground dark:group-hover:bg-foreground-soft',
