...
export const viewModeSliderTheme = tv({
  slots: {
    ...
    track:
      'relative isolate flex items-stretch bg-gradient-to-br from-slate-100 to-slate-200/60 dark:from-slate-800/60 dark:to-slate-700/40 border border-slate-200 dark:border-slate-700 p-0.5',
    thumb:
      'absolute top-0.5 bottom-0.5 left-0.5 z-0 bg-white dark:bg-slate-600 shadow-sm ring-1 ring-slate-200/60 dark:ring-slate-500/40 motion-safe:transition-transform motion-safe:duration-300 motion-safe:ease-out pointer-events-none',
