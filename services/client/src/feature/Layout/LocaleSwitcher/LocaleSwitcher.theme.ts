...
export const LocaleSwitcherTheme = cva(
...
export const LocaleSwitcherIcon = cva('transition-all duration-300 ease-out', {
  variants: {
    size: {
      sm: 'h-3 w-3',
      md: 'h-4 w-4',
...
export const LocaleSwitcherItem = cva(
  'flex items-center gap-2 w-full px-3 py-2 text-sm cursor-pointer rounded-md transition-colors',
  {
    variants: {
      active: {
        true: 'bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 font-medium',
        false:
