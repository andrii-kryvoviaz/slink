...
{#if shouldShow}
  ...
  >
    <button
      class="flex-1 flex items-center gap-2 px-3 py-2 text-sm rounded-xl transition-all duration-300 text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-800/40 focus:outline-none focus:ring-2 focus:ring-blue-300/50 dark:focus:ring-blue-600/50"
      onclick={onCreateTag}
      disabled={isCreating}
    >
      {#if isCreating}
