...
export const tagTreeNodeVariants = tv({
  slots: {
    node: 'flex flex-col',
    row: 'group flex items-center gap-1 rounded-lg pr-1.5 transition-colors duration-150 hover:bg-ghost-hover',
    toggle:
    ...
    count:
      'inline-flex shrink-0 items-center rounded-md bg-muted px-1.5 py-0.5 tabular-nums text-xs font-medium text-muted-foreground transition-colors hover:bg-info-fill/8 hover:text-info',
    countEmpty:
