...
<Sidebar.Root bind:ref {collapsible} {...restProps}>
  <Sidebar.Header>
    ...
    >
      <div
        class="absolute inset-0 bg-gradient-to-r from-transparent via-sidebar-hover/5 to-transparent rounded-lg"
      ></div>
      <a
        href="/"
        class="relative w-8 h-8 rounded-lg bg-gradient-to-br from-sidebar-hover/30 via-sidebar-hover/40 to-sidebar-hover/20 border border-sidebar-border/60 flex items-center justify-center hover:border-sidebar-border/80 transition-all duration-300 hover:scale-105 group dark:from-sidebar-primary/15 dark:via-sidebar-hover/20 dark:to-sidebar-primary/10 dark:border-sidebar-border/40 dark:hover:border-sidebar-border/60"
      >
        <BrandLogo
      ...
      <a
        href="/"
        class="relative font-semibold text-on-sidebar/90 tracking-tight group-data-[collapsible=icon]:hidden hover:text-on-sidebar transition-colors"
