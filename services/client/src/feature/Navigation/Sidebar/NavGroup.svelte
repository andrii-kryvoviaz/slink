          ...
          >
            <Sidebar.MenuItem>
              ...
              >
                <Sidebar.MenuButton
                  isActive={isActive || isChildActive(item)}
                  class="flex-1 rounded-r-none hover:pl-4 data-[active=true]:pl-4 group-hover/item:bg-accent-subtle/80 group-hover/item:text-accent-subtle-foreground transition-all duration-200 ease-out"
                >
                  ...
                  {#snippet child({ props })}
                    <button
                      ...
                      aria-label={expandedItems[item.id]
                        ? 'Collapse submenu'
                        : 'Expand submenu'}
                      class="flex h-8 w-8 shrink-0 items-center justify-center rounded-r-md text-muted-foreground group-hover/item:bg-accent-subtle/80 group-hover/item:text-accent group-data-[active=true]/item:bg-accent-subtle/80 group-data-[active=true]/item:text-accent-subtle-foreground hover:text-accent-deep-foreground transition-all duration-200 ease-out cursor-pointer"
                    >
                      <Icon
                        icon="ph:caret-right"
