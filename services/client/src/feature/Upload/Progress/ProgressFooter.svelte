...
{#if progress.isCompleted && onViewAll}
  ...
  >
    ...
    <button
      type="button"
      onclick={onViewAll}
      class="group/link inline-flex items-center gap-1.5 text-xs font-medium text-foreground-muted hover:text-foreground-soft transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent rounded"
    >
      View all
      <Icon
        icon="ph:arrow-right"
