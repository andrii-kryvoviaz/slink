...
final class QualityOptimizationStrategyTest extends TestCase {
    ...
    public function itTransformsImageQuality(): void {
        ...
        $strategy = new QualityOptimizationStrategy($imageProcessor);
    ...
    public function itHandlesDifferentQualityValues(): void {
        ...
        $strategy = new QualityOptimizationStrategy($imageProcessor);
        $lowResult = $strategy->transform($imageContent, $originalDimensions, $lowQualityRequest);
        $highResult = $strategy->transform($imageContent, $originalDimensions, $highQualityRequest);
    ...
    public function itReturnsOriginalWhenQualityIsNull(): void {
        ...
        $imageProcessor = $this->createMock(ImageProcessorInterface::class);
        $imageProcessor->expects($this->never())->method('convertFormat');
