...
#[AsController]
#[Route(path: '/collection/{id}/items/{page}', name: 'get_shared_collection_items', methods: ['GET'], requirements: ['page' => '\d+'], priority: -1)]
final readonly class GetPublicCollectionItemsController {
  ...
  public function __invoke(
    ...
    $result = $this->ask(new GetCollectionItemsQuery($id, $page));
