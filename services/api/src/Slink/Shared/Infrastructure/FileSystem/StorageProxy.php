...
#[AsAlias(StorageCacheInterface::class)]
final class StorageProxy implements StorageInterface, StorageCacheInterface {
  protected StorageInterface&StorageCacheInterface $storageProvider {
  ...
  public function readImage(string $fileName): ?string {
    return $this->storageProvider->readImage($fileName);
  }
