...
final readonly class OwnershipPlan {
  ...
  public static function fromStoragePaths(string $appDir, string $apiVarDir, string $dataDir, string $runDir): self {
    return new self([
      ...
      new OwnershipEntry(path: $appDir . '/slink/images', mode: 0o2770),
      new OwnershipEntry(path: $appDir . '/slink/cache', mode: 0o2770, optional: true),
      new OwnershipEntry(path: $appDir . '/slink/chunks', mode: 0o2770, optional: true),
