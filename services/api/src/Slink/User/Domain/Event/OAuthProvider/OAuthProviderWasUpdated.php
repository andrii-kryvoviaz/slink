...
final readonly class OAuthProviderWasUpdated implements SerializablePayload {
  public function __construct(
    ...
    public ?RegistrationPolicy $registrationPolicy = null,
    public ?ApprovalPolicy $approvalPolicy = null,
  ...
  public function toPayload(): array {
    ...
    if ($this->slug !== null) $payload['slug'] = $this->slug->toString();
    ...
    if ($this->registrationPolicy !== null) $payload['registrationPolicy'] = $this->registrationPolicy->value;
    if ($this->approvalPolicy !== null) $payload['approvalPolicy'] = $this->approvalPolicy->value;
  ...
  public static function fromPayload(array $payload): static {
    return new self(
      ...
      isset($payload['slug']) ? ProviderSlug::fromString($payload['slug']) : null,
      ...
      isset($payload['registrationPolicy']) ? RegistrationPolicy::from($payload['registrationPolicy']) : null,
      isset($payload['approvalPolicy']) ? ApprovalPolicy::from($payload['approvalPolicy']) : null,
