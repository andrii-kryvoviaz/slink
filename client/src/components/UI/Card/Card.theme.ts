...
export const CardTheme = cva(`flex flex-col border w-full`, {
  variants: {
    variant: {
      ...
      default:
        'bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 border-gray-200 dark:border-gray-700 divide-gray-200 dark:divide-gray-700',
      dropdown:
