...
export class IconFile {
  ...
  private constructor(private readonly filePath: string) {
    ...
    this.iconRegistry = IconRegistry.create(RegexHelper.extractRegexGroupsToArray('ICON_LINE', content));
    this.variableDeclaration = RegexHelper.matchString('VARIABLE_DECLARATION', content, {
  ...
  public processTemplate(filePath: string): void {
    ...
    const parsedIcons = RegexHelper.extractRegexGroupsToArray('ICON_TAG', content, {
      group: 3
    });
